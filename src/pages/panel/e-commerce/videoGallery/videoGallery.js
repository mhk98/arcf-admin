...
} from "../../../../features/videoGallery/videoGallery";
...
const VideoGallery = () => {
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      const res = await createVideoGallery(info);
      if (res) {
  ...
  const [updateVideoGallery] = useUpdateVideoGalleryMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await updateVideoGallery({ id: updateId, data: info });
      ...
      <Content>
          ...
          <PreviewAltCard>
            {videoGallery.length > 0 ? (
              ...
              <div className="text-center">
                <span className="text-silent">No video found</span>
              </div>
            )}
          </PreviewAltCard>
        </Block>
        ...
        <Modal isOpen={view.edit} toggle={() => onFormCancel()} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Video</h5>
              <div className="mt-4">
        ...
        >
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Add Video</BlockTitle>
              <BlockDes>
                <p>Add information or update Video.</p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
          <Block>
