...
} from "../../../../features/upcomingEvents/upcomingEvents";
...
const UpcomingEvents = () => {
  ...
  const [updateEvents] = useUpdateEventsMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await updateEvents({ id: updateId, data: formData });
