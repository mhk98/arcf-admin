...
} from "../../../../features/volunteer/volunteer";
...
const Volunteer = () => {
  ...
  const { data, isLoading, error } = useGetAllVolunteerQuery();
  ...
  const [updateVolunteer] = useUpdateVolunteerMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await updateVolunteer({ id: updateId, data: formData });
      ...
      <Content>
          ...
          <PreviewAltCard>
            {slider.length > 0 ? (
              ...
              <div className="text-center">
                <span className="text-silent">No volunteer found</span>
              </div>
            )}
          </PreviewAltCard>
        </Block>
        ...
        <Modal isOpen={view.edit} toggle={() => onFormCancel()} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Volunteer</h5>
              <div className="mt-4">
        ...
        >
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Add Volunteer</BlockTitle>
              <BlockDes>
                <p>Add information or update volunteer.</p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
          <Block>
