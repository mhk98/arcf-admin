...
const Banner = () => {
  ...
  const { data, isLoading, error } = useGetAllBannerQuery();
  ...
  const [updateBanner] = useUpdateBannerMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await updateBanner({ id: updateId, data: formData });
      ...
      <Content>
          ...
          <PreviewAltCard>
            {projects.length > 0 ? (
              ...
              <div className="text-center">
                <span className="text-silent">No banner found</span>
              </div>
            )}
          </PreviewAltCard>
        </Block>
        ...
        <Modal isOpen={view.edit} toggle={() => onFormCancel()} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Banner</h5>
              <div className="mt-4">
