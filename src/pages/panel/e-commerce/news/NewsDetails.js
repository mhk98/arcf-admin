...
} from "../../../../features/newsDetails/newsDetails";
...
const NewsDetails = () => {
  ...
  const { data, isLoading, error } = useGetAllNewsDetailsQuery();
  const [createNews] = useCreateNewsDetailsMutation();
  ...
  const [updateNewsDetails] = useUpdateNewsDetailsMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await updateNewsDetails({ id: updateId, data: formData });
  ...
  const [deleteNews] = useDeleteNewsDetailsMutation();
    ...
    <React.Fragment>
      ...
      <Content>
        ...
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle>News Details</BlockTitle>
            </BlockHeadContent>
            <BlockHeadContent>
          ...
          <PreviewAltCard>
            {projects.length > 0 ? (
              ...
              <div className="text-center">
                <span className="text-silent">No News details found</span>
              </div>
            )}
          </PreviewAltCard>
        </Block>
        ...
        <Modal isOpen={view.edit} toggle={() => onFormCancel()} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update News Details</h5>
              <div className="mt-4">
        ...
        >
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Add News Details</BlockTitle>
              <BlockDes>
                <p>Add information or update News Details.</p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
          <Block>
