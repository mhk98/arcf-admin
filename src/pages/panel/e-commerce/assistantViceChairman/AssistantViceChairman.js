...
} from "../../../../features/assistantViceChairman/assistantViceChairman";
import Content from "../../../../layout/content/Content";
import Head from "../../../../layout/head/Head";

const AssistantViceChairman = () => {
  ...
  const { data, isLoading, error } = useGetAllAssistantViceChairmanQuery();
  const [createAssistantViceChairman] = useCreateAssistantViceChairmanMutation();
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      const res = await createAssistantViceChairman(formData);
      if (res) {
  ...
  const [updateAssistantViceChairman] = useUpdateAssistantViceChairmanMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    formData.append("image", image);
    try {
      const response = await updateAssistantViceChairman({ id: updateId, data: formData });
  ...
  const [deleteAssistantViceChairman] = useDeleteAssistantViceChairmanMutation();

  // Function to delete a category
  const handleDeleteSlider = async (id) => {
    try {
      const res = await deleteAssistantViceChairman(id);
      if (res) {
        toast.success(res.data.message);
      }
    } catch (error) {
    ...
    <React.Fragment>
      ...
      <Content>
                ...
                <div className="toggle-expand-content" style={{ display: sm ? "block" : "none" }}>
                  <ul className="nk-block-tools g-3">
                    ...
                    <li className="nk-block-tools-opt">
                      ...
                      >
                        <Icon name="plus"></Icon>
                        <span>Add Assistant Vice Chairman</span>
                      </Button>
                    </li>
                  </ul>
                </div>
        ...
        >
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Add Assistant Vice Chairman</BlockTitle>
              <BlockDes>
...
export default AssistantViceChairman;
