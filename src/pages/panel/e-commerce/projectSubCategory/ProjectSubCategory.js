...
} from "../../../../features/projectSubCategory/projectSubCategory";
...
const ProjectSubCategory = () => {
  ...
  const { data, isLoading, isError, error } = useGetAllProjectSubCategoryQuery();
  ...
  const [createProjectSubCategory] = useCreateProjectSubCategoryMutation();
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      const res = await createProjectSubCategory({ id: projectId, data: formData });
      if (res) {
  ...
  const [updateProjectSubCategory] = useUpdateProjectSubCategoryMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await updateProjectSubCategory({ id: updateId, data: formData });
  ...
  const [deleteProjectSubCategory] = useDeleteProjectSubCategoryMutation();

  // Function to delete a category
  const handleDeleteBanner = async (id) => {
    try {
      const res = await deleteProjectSubCategory(id);
      if (res) {
        toast.success(res.data.message);
      }
    } catch (error) {
    ...
    <React.Fragment>
      ...
      <Content>
        ...
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle>Subcategory</BlockTitle>
            </BlockHeadContent>
            <BlockHeadContent>
