...
} from "../../../../features/Education/Education.js";
...
const Education = () => {
  ...
  const { data, isLoading, error } = useGetAllEducationQuery();
  ...
  const [updateEducation] = useUpdateEducationMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    formData.append("image", image);
    try {
      const response = await updateEducation({ id: updateId, data: formData });
                    ...
                    <Col size="12">
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          ...
                          />
                          {errors.title1 && <span className="invalid">{errors.title1.message}</span>}
                        </div>
                      </div>
                    </Col>
                    <Col size="12">
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          ...
                          />
                          {errors.title2 && <span className="invalid">{errors.title2.message}</span>}
                        </div>
                      </div>
                    </Col>
                    <Col size="12">
