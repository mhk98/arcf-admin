...
} from "../../../../features/newsCategroyDesicription/newsCategroyDesicription";
import { useGetAllNewsQuery } from "../../../../features/upcomingNews/upcomingNews";
// import { productData } from "../product/ProductData";

const NewsCategoryDescription = () => {
  ...
  const { data, isLoading, isError, error } = useGetAllnewsCategoryDescriptionQuery();
  ...
  const id = subCategory.charAt(0);
  const restSubCategory = subCategory.substring(1);

  console.log("subCategory", id);

  const [createnewsCategoryDescription] = useCreatenewsCategoryDescriptionMutation();
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      const res = await createnewsCategoryDescription({
        id: categoryId,
        data: formData,
      });
      if (res) {
  ...
  const [updatenewsCategoryDescription] = useUpdatenewsCategoryDescriptionMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await updatenewsCategoryDescription({
        id: categoryId,
  ...
  const [deletenewsCategoryDescription] = useDeletenewsCategoryDescriptionMutation();

  // Function to delete a category
  const handleDeleteBanner = async (id) => {
    try {
      const res = await deletenewsCategoryDescription(id);
      if (res) {
        toast.success(res.data.message);
      }
    } catch (error) {
  ...
  const { data: data1, isLoading: isLoading1, isError: isError1, error: error1 } = useGetAllNewsQuery();
  useEffect(() => {
    if (isError1) {
      ...
      <Content>
                ...
                <div className="toggle-expand-content" style={{ display: sm ? "block" : "none" }}>
                  <ul className="nk-block-tools g-3">
                    ...
                    <li className="nk-block-tools-opt">
                      ...
                      >
                        <Icon name="plus"></Icon>
                        <span>Add News Category Description</span>
                      </Button>
                    </li>
                  </ul>
                </div>
        ...
        <Block>
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow size="sm">
                <span>News category Description</span>
              </DataTableRow>
              <DataTableRow size="sm">
                <span>Category</span>
              </DataTableRow>
                              ...
                              <ul className="link-list-opt no-bdr">
                                ...
                                <li>
                                  ...
                                  >
                                    ...
                                    <span>Remove News category</span>
                                  </DropdownItem>
                                </li>
                              </ul>
                            </DropdownMenu>
        ...
        <Modal isOpen={view.edit} toggle={() => onFormCancel()} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update News category</h5>
              <div className="mt-4">
        ...
        >
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Add News category</BlockTitle>
              <BlockDes>
                <p>Add information or update News category.</p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
          <Block>
