...
} from "../../../../features/projectBanner/projectBanner";
...
const ProjectBanner = () => {
  ...
  const { data, isLoading, error } = useGetAllProjectsBannerQuery();
  const [createProjectsBanner] = useCreateProjectsBannerMutation();
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      const res = await createProjectsBanner(formData);
      if (res) {
  ...
  const [updateProjectsBanner] = useUpdateProjectsBannerMutation(); // Use the generated update hook
  ...
  const onEditSubmit = async (data) => {
    ...
    try {
      const response = await updateProjectsBanner({ id: updateId, data: formData });
  ...
  const [deleteProjectsBanner] = useDeleteProjectsBannerMutation();
